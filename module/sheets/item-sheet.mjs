...
export class KerNethalasItemSheet extends HandlebarsApplicationMixin(ItemSheetV2) {
    #dragDrop // Private field to hold dragDrop handlers

    /** @inheritDoc */
    static DEFAULT_OPTIONS = {
        classes: ['ker-nethalas', 'sheet', 'item'],
        tag: 'form',
        position: {
            width: 600,
            height: 550
        ...
        dragDrop: [{
            ...
            dropSelector: '.ker-nethalas.item'
        }],
        window: {
            resizable: true,
            controls: [
   ...
   */
    ...
    _configureRenderParts(options) {
        ...
        let templatePath = `systems/ker-nethalas-fvtt/templates/item/item-${this.document.type}-sheet.hbs`;
